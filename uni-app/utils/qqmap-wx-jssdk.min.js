...
class QQMapWX {
	...
	reverseGeocoder(options) {
		...
		var locationsuccess = function (result) {
			...
			wx.request(
				Utils.buildWxRequestConfig(options, { url: URL_GET_GEOCODER, data: requestParam }, 'reverseGeocoder'),
			);
		};
		Utils.locationProcess(options, locationsuccess);
	}
	...
	getDistrictByCityId(options) {
		...
		wx.request(
			Utils.buildWxRequestConfig(options, { url: URL_AREA_LIST, data: requestParam }, 'getDistrictByCityId'),
		);
	}
	calculateDistance(options) {
		...
		if (requestParam.mode == 'straight') {
			...
			var locationsuccess = function (result) {
				...
				wx.request(
					Utils.buildWxRequestConfig(options, { url: URL_DISTANCE, data: requestParam }, 'calculateDistance'),
				);
			};
			Utils.locationProcess(options, locationsuccess);
		}
	...
	direction(options) {
		...
		var locationsuccess = function (result) {
			...
			wx.request(
				Utils.buildWxRequestConfig(options, { url: SET_URL_DIRECTION, data: requestParam }, 'direction'),
			);
		};
		Utils.locationProcess(options, locationsuccess);
	}
